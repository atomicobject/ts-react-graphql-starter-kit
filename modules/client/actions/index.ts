...
interface ActionBuilder<T> {
  ...
  <K1 extends keyof T, K2 extends keyof T>(k1: K1, k2: K2): (v1: T[K1], v2: T[K2]) => T;
  <K1 extends keyof T, K2 extends keyof T, K3 extends keyof T>(k1: K1, k2: K2, k3: K3): (v1: T[K1], v2: T[K2], v3: T[K3]) => T;
}
 ...
 */
export function actionBuilder<T extends {type: ActionTypeKeys}>(s: T['type']) : ActionBuilder<T> {
  return (...keys: (keyof T)[]) => {
    return (...values: any[]) => {
...
export const guessSubmitted = actionBuilder<GuessSubmittedAction>(ActionTypes.GUESS_SUBMITTED)('value')
...
export const goodGuessOccurred = actionBuilder<GoodGuessOccurredAction>(ActionTypes.GOOD_GUESS_OCCURRED)('value')
...
export const badGuessOccurred = actionBuilder<BadGuessOccurredAction>(ActionTypes.BAD_GUESS_OCCURRED)('value');
...
export const gameWon = actionBuilder<GameWonAction>(ActionTypes.GAME_WON)('correctAnswer');
